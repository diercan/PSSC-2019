...
namespace Modele.Disciplina
{
    public class Disciplina
    {
        ...
        public void TreceNoteExamen(Dictionary<NumarMatricol, Nota> rezultateExamen, DateTime dataExamen)
        {
            ...
            foreach (var pair in rezultateExamen)
            {
                ...
                student.DataNotaExamen = dataExamen;
                student.NotaExamenPublicata = false;
            }
        }

        public void MacheazaNoteCaPublicate()
        {
            _studentiInscrisi.ForEach(s => s.NotaExamenPublicata = true);
        }
