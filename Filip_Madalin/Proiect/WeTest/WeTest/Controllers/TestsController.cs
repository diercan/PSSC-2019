...
namespace WeTest.Controllers
{
    public class TestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestId,TestTitle,Functionality")] Test test)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("TestId,TestTitle,Functionality")] Test test)
        {
            if (id != test.TestId)
            {
                return NotFound();
