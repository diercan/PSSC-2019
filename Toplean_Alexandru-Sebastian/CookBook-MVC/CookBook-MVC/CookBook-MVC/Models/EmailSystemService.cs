...
using CookBook_MVC.Models.EmailComponents;
    ...
    public class EmailSystemService
    {
        ...
        private void SendConfirmationEmail(EmailAddress emailAddress, User user)
        {
            try
            {
                ...
                mail.Body = "Hello "+user.GetUserName+ " " + user.GetUserSurename+Environment.NewLine + Environment.NewLine + Environment.NewLine +
