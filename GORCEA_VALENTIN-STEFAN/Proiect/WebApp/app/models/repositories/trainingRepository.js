...
function TrainingRepository(config, dbService) {
  this._dbService = dbService;
  this._config = config;
}

TrainingRepository.prototype.getTrainings = async function (userName) {
...
TrainingRepository.prototype.joinTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
...
TrainingRepository.prototype.createTraining = async function (training, user) {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let result = await this._dbService.query(sql, [training.topic, training.description, training.location, training.scheduledOn.split("T")[0], user.id, training.maxAttendees, 0, training.durationHours]);
...
TrainingRepository.prototype.cancelJoinTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
...
TrainingRepository.prototype.deleteTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
