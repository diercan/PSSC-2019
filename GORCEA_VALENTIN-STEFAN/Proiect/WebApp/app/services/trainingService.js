...
function TrainingService(config, dbService) {
  this._dbService = dbService;
  this._config = config;
}

TrainingService.prototype.getTrainings = async function (userName) {
...
TrainingService.prototype.joinTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
...
TrainingService.prototype.createTraining = async function (training, user) {
  return new Promise(async (resolve, reject) => {
    try {
...
TrainingService.prototype.cancelJoinTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
...
TrainingService.prototype.deleteTraining = async function (trainingId, userName) {
  return new Promise(async (resolve, reject) => {
    try {
